...
def process_trips_to_data_lake(**kwargs):
    ...
    trips['batch'] = kwargs.get("ts_nodash")
...
for task in api_extract_tasks:
    task >> trip_external_stage_task


for task in trip_remote_files_delete_tasks:
    trip_external_stage_task >> task
...
trip_external_stage_task >> trip_stage_task
